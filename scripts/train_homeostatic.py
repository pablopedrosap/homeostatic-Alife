#!/usr/bin/env python3
"""
Train a PPO agent with homeostatic (drive-reduction) reward.

Usage:
    python scripts/train_homeostatic.py --steps 100000 --seed 42
    python scripts/train_homeostatic.py --smoke  # Quick smoke test (10k steps)
"""
...
RESULTS_DIR = Path("results/homeostatic")


def main():
    parser = argparse.ArgumentParser(description="Train homeostatic reward agent")
    ...
    # Configure environment with homeostatic reward
    ...
    # Save
    model_path = RESULTS_DIR / "ppo_homeostatic"
